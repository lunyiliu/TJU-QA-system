...
class TfidfModel():
    ...
    def update(self):
        ...
        dictionary.save(DATA_ROOT+'\\tfidf-model-letter-words\\deerwester.dict')
        ...
        corpora.MmCorpus.serialize(DATA_ROOT+'\\tfidf-model-letter-words\\corpus.mm', processed_corpus)
        tfidf_model.save(DATA_ROOT+'\\tfidf-model-letter-words\\mytfidfmodel.model')
        bow_tfidf = tfidf_model[processed_corpus]
        similarity_tfidf = similarities.Similarity \
            (DATA_ROOT+'\\tfidf-model-letter-words\\Similarity-tfidf.index', bow_tfidf, num_features=9999)
        similarity_tfidf.save(DATA_ROOT+'\\tfidf-model-letter-words\\Similarity-tfidf.index')
    ...
    def load(self):
        ...
        tfidf_model = models.TfidfModel.load (DATA_ROOT+'\\tfidf-model-letter-words\\mytfidfmodel.model')
        print('load corpus')
        precessed_corpus = corpora.MmCorpus(DATA_ROOT+'\\tfidf-model-letter-words\\corpus.mm')
        print('load Similarity')
        similarities_tfidf = similarities.Similarity.load (DATA_ROOT+'\\tfidf-model-letter-words\\Similarity-tfidf.index')
...
class TfidfModel_template():
    ...
    def update(self):
        ...
        dictionary.save(DATA_ROOT+'\\tfidf-model-letter-words_1\\deerwester.dict')
        processed_corpus_all = [dictionary.doc2bow(end_que) for end_que \
                                in self.corpus_all]
        processed_corpus = [dictionary.doc2bow(end_que) for end_que \
                            in self.tfidf_corpus]
        tfidf_model = models.TfidfModel(processed_corpus_all)
        corpora.MmCorpus.serialize(DATA_ROOT+'\\tfidf-model-letter-words_1\\corpus.mm', processed_corpus_all)
        tfidf_model.save(DATA_ROOT+'\\tfidf-model-letter-words_1\\mytfidfmodel.model')
        bow_tfidf = tfidf_model[processed_corpus]
        similarity_tfidf = similarities.Similarity \
            (DATA_ROOT+'\\tfidf-model-letter-words_1\\Similarity-tfidf.index', bow_tfidf, num_features=9999)
        similarity_tfidf.save(DATA_ROOT+'\\tfidf-model-letter-words_1\\Similarity-tfidf.index')

    def load(self):
        print('--------load tfidf-------------')
        print('load dictionnary')
        dictionary = corpora.Dictionary.load \
            (DATA_ROOT+'\\tfidf-model-letter-words_1\\deerwester.dict')
        print('load tfidf_model')
        tfidf_model = models.TfidfModel.load \
            (DATA_ROOT+'\\tfidf-model-letter-words_1\\mytfidfmodel.model')
        print('load corpus')
        precessed_corpus = corpora.MmCorpus(DATA_ROOT+'\\tfidf-model-letter-words_1\\corpus.mm')
        print('load Similarity')
        similarities_tfidf = similarities.Similarity.load \
            (DATA_ROOT+'\\tfidf-model-letter-words_1\\Similarity-tfidf.index')
        print('load done')
        return dictionary, tfidf_model, precessed_corpus, similarities_tfidf
