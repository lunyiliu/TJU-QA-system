from gensim_store import TfidfModel
from gensim_store import get_dic_from_excel_file
from gensim_store import pre_process_question
DATA_ROOT=r'C:\Users\lenovvo\Desktop\吴偶教授\天津大学智能问答\天大美食智能问答\gensim_食品_地点_店家归类\店家'
excel_file = DATA_ROOT+'\\data\\stores.xlsx'
...
'''
def get_most_similar_stores(input_str):
