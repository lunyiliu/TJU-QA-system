...
def read_file(file_path):
    ...
    if os.path.isfile(file_path):
        ...
        for index in range(len(data_frame)):
            if pd.isna(data_frame.iloc[index,0]):
                continue
...
class TfidfModel():
    ...
    def load(self):
        ...
        #print(self.tfidf_model.output_prefix)
    ...
    def query(self, user_question):
        ...
        #print(self.similarities_tfidf.output_prefix)
        #print('ddd')
